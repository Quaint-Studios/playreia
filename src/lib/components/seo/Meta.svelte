<script>
	...
	export let title = 'Explore an Endlessly Exciting Magical Adventure';
	...
	export let reia_logo_meta = '/reia_logo_meta.png';
	export let canonical = true;
</script>

<svelte:head>
	{#if canonical}
		<link rel="canonical" href={`https://forlabeau.com${$page.url.pathname}`} />
	{/if}
