...
<div>
	...
	<p>
		We operate the website <a href="https://www.playreia.com">https://www.playreia.com</a> (the "Site"),
		the mobile application Reia (the "App"), as well as any other related products and services that
		refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
	</p>
	<p>
		We provide you with the means to create and distribute content on our platform. We also provide
		subscription services that enable you to gain access to early content. The primary function of
		this application is to provide you, the user, with a game experience.
	</p>
	<p>
		You can contact us by email at legal@playreia.com or by mail to __________, __________,
		__________.
	</p>
	<p>
		These Legal Terms constitute a legally binding agreement made between you, whether personally or
		on behalf of an entity ("you"), and Quaint Studios, concerning your access to and use of the
	...
	<p>
		...
		noreply@playreia.com, as stated in the email message. By continuing to use the Services after
	...
	<p>
		<a href="#returnno">7. RETURN/REFUNDS POLICY</a>
	</p>
	<p>
	...
	<p>
		<a href="#license">11. CONTRIBUTION LICENSE</a>
	</p>
	<p>
		<a href="#reviews">12. GUIDELINES FOR REVIEWS</a>
	</p>
	<p>
		<a href="#mobile">13. MOBILE APPLICATION LICENSE</a>
	</p>
	<p>
		<a href="#socialmedia">14. SOCIAL MEDIA</a>
	</p>
	<p>
		<a href="#thirdparty">15. THIRD-PARTY WEBSITES AND CONTENT</a>
	</p>
	<p>
		<a href="#sitemanage">16. SERVICES MANAGEMENT</a>
	</p>
	<p>
		<a href="#ppyes">17. PRIVACY POLICY</a>
	</p>
	<p>
		<a href="#copyrightyes">18. COPYRIGHT INFRINGEMENTS</a>
	</p>
	<p>
	...
	<p>
		<a href="#electronic">28. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a>
	</p>
	<p>
	...
	<p>
		...
		section or elsewhere in our Legal Terms, please address your request to: legal@playreia.com. If
	...
	<ul>
		...
		<li><p>Sell in-game goods for real-world money.</p></li>
		<li>
	...
	<p>
		...
		into these Legal Terms. Please be advised the Services are hosted in the United States, Germany,
		India, Australia, United Kingdom, Canada and Singapore. If you access the Services from any
		other region of the world with laws or other requirements governing personal data collection,
		use, or disclosure that differ from applicable laws in the United States, Germany, India,
		Australia, United Kingdom, Canada and Singapore, then through your continued use of the
		Services, you are transferring your data to the United States, Germany, India, Australia, United
		Kingdom, Canada and Singapore, and you expressly consent to have your data transferred to and
		processed in the United States, Germany, India, Australia, United Kingdom, Canada and Singapore.
	...
	<p>
		...
		Rules"), both of which are available at the<a href="http://www.adr.org">
		...
		applicable law, the arbitration will take place in United States of America, Florida. Except as
