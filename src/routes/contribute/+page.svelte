...
<ContentContainer>
	...
	<p>
		You can contribute via the GitHub repository <a
			class="btn bg-primary-500 py-1"
			href={socials.github}>here</a
		>
		<br /><br />
	...
	<p>
		...
		funding long-term. Currently we're thinking of <a href={socials.open_collective}
			>Open Collective</a
