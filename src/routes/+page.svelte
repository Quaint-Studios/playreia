<script>
	...
	import InfoBlog from '$lib/components/section/InfoBlog.svelte';
...
<Meta
  ...
  description="Reia is an exciting new game with an amazing story, combat, crafting, and your own floating islands. Made in Godot, Reia is an open-source action adventure RPG."
>
