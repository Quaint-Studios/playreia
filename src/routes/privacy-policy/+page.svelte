...
<div>
	...
	<p>
		...
		can find out more about this in our Cookie Notice:<a href="https://www.playreia.com/cookies">
			https://www.playreia.com/cookies</a
		>.
	</p>
	...
	<ul>
		<li>
			<p>
				...
				type and settings of the device you use to access the Services. For example, we may use GPS
	...
	<ul>
		<li>
			<p>
				...
				For more information see our Cookie Notice:<a href="https://www.playreia.com/cookies">
					https://www.playreia.com/cookies</a
				>.
			</p>
		</li>
	...
	<ul>
		<li>
			<p>
				...
				your information to better understand how to provide marketing and promotional campaigns
	...
	<ul>
		<li><p>Develop and display personalized and relevant advertising content for our users</p></li>
	</ul>
	<ul>
		<li>
	...
	<ul><li><p>Support our marketing activities</p></li></ul>
	<ul><li><p>Diagnose problems and/or prevent fraudulent activities</p></li></ul>
	<ul>
		<li>
			<p>
	...
	<ul><li><p>For investigations and fraud detection and prevention</p></li></ul>
	<ul><li><p>For business transactions provided certain conditions are met</p></li></ul>
	<ul>
		<li>
			<p>
	...
	<ul>
		<li>
			<p>
				...
				the Services, such personal information may be viewed by all users and may be publicly made
				available outside the Services in perpetuity. If you interact with other users of our
	...
	<p>
		...
		refuse certain cookies is set out in our Cookie Notice:<a
			href="https://www.playreia.com/cookies"
		>
			https://www.playreia.com/cookies</a
		>.
	</p>
	...
	<p>
		...
		us keeping your personal information for longer than &nbsp; three (3) months past the
	...
	<ul><li><p>Log in to your account settings and update your user account.</p></li></ul>
	<p>
	...
	<p>
		...
		of our Services. For further information, please see our Cookie Notice:<a
			href="https://www.playreia.com/cookies"
		>
			https://www.playreia.com/cookies</a
		>.
	...
	<div>
		<table>
			<tbody
				><tr><td><p>Category</p></td><td><p>Examples</p></td><td><p>Collected</p></td></tr><tr
					><td><p>A. Identifiers</p></td><td
						><p>
	...
	<div>
		<table>
			<tbody
				><tr
					><td><p>C. Protected classification characteristics under state or federal law</p></td><td
						><p>Gender and date of birth</p></td
					><td><p>YES</p></td></tr
				><tr
					><td><p>D. Commercial information</p></td><td
						><p>
							Transaction information, purchase history, financial details, and payment information
						</p></td
					><td><p>YES</p></td></tr
				><tr
					><td><p>E. Biometric information</p></td><td><p>Fingerprints and voiceprints</p></td><td
						><p>NO</p></td
					></tr
				><tr
					><td><p>F. Internet or other similar network activity</p></td><td
						><p>
					...
					><td><p>YES</p></td></tr
				><tr
					><td><p>G. Geolocation data</p></td><td><p>Device location</p></td><td><p>YES</p></td></tr
				><tr
					...
					><td><p>NO</p></td></tr
				><tr
					><td><p>I. Professional or employment-related information</p></td><td
						><p>
					...
					><td><p>NO</p></td></tr
				><tr
					><td><p>J. Education Information</p></td><td
						><p>Student records and directory information</p></td
					><td><p>NO</p></td></tr
				><tr
					><td><p>K. Inferences drawn from collected personal information</p></td><td
						><p>
					...
					><td><p>NO</p></td></tr
				><tr><td><p>L. Sensitive personal Information</p></td><td></td><td><p>NO</p></td></tr
				></tbody
			>
		</table>
	</div>
	...
	<ul><li><p>Category A - three (3) months pas</p></li></ul>
	<ul><li><p>Category B - three (3) months past the termination of the user's account.</p></li></ul>
	<ul><li><p>Category C - three (3) months past the termination of the user's account.</p></li></ul>
	<ul><li><p>Category D - three (3) months past the termination of the user's account.</p></li></ul>
	<ul><li><p>Category F - three (3) months past the termination of the user's account.</p></li></ul>
	<ul><li><p>Category G - three (3) months past the termination of the user's account.</p></li></ul>
	<p>
	...
	<ul><li><p>Receiving help through our customer support channels;</p></li></ul>
	<ul><li><p>Participation in customer surveys or contests; and</p></li></ul>
	<ul>
	...
	<ul><li><p>whether we collect and use your personal information;</p></li></ul>
	<ul><li><p>the categories of personal information that we collect;</p></li></ul>
	<ul><li><p>the purposes for which the collected personal information is used;</p></li></ul>
	<ul><li><p>whether we sell or share personal information to third parties;</p></li></ul>
	<ul>
		<li>
			<p>
	...
	<ul><li><p>the specific pieces of personal information we collected about you.</p></li></ul>
	<p>
	...
	<ul><li><p>You may object to the processing of your personal information.</p></li></ul>
	<ul>
		<li>
			<p>
	...
	<p>
		This section applies only to Colorado residents. Under the Colorado Privacy Act (CPA), you have
	...
	<ul><li><p>Right to be informed whether or not we are processing your personal data</p></li></ul>
	<ul><li><p>Right to access your personal data</p></li></ul>
	<ul><li><p>Right to correct inaccuracies in your personal data</p></li></ul>
	<ul><li><p>Right to request deletion of your personal data</p></li></ul>
	<ul><li><p>Right to obtain a copy of the personal data you previously shared with us</p></li></ul>
	<ul>
		<li>
			<p>
	...
	<p>
		...
		email us at privacy@playreia.com. Within forty-five (45) days of receipt of an appeal, we will
	...
	<p>
		If we decline to take action regarding your request and you wish to appeal our decision, please
		email us at privacy@playreia.com. Within sixty (60) days of receipt of an appeal, we will inform
	...
	<p>
		...
		privacy@playreia.com. Within sixty (60) days of receipt of an appeal, we will inform you in
		writing of any action taken or not taken in response to the appeal, including a written
		explanation of the reasons for the decisions. If your appeal is denied, you may contact the<a
	...
	<p>
		This privacy notice satisfies the notice requirements defined in the Privacy Act, in particular:
	...
	<ul><li><p>offer you the products or services that you want</p></li></ul>
	<ul><li><p>respond to or help with your requests</p></li></ul>
	<ul><li><p>manage your account with us</p></li></ul>
	<ul><li><p>confirm your identity and protect your account</p></li></ul>
	<p>
	...
	<p>
		...
		submit a complaint about a breach of the Australian Privacy Principles to the<a
	...
	<p>
		If you have questions or comments about this notice, you may email us at privacy@playreia.com or
